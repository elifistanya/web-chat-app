<template>
  <div class="wrapper">
    <button type="button" class="btn btn-info" v-on:click="goBack">Geri</button>

    <div class="w-100 mt-3">
      <h2 class="fw-600">Profilini Düzenle</h2>
      <div class="profile">
        <img class="br-06" :src="photoURL" width="100%" height="100%" />
        <label class="avatar" style="background-color: white">
          <font-awesome-icon
